...
exports.lang = {
    ...
    range_gt: "を入力して大なりイコール{1}の数",
    range_lt: "を入力してください小なりイコール{1}の数",
    
    checked_eq: "{1}項目を選択してください",
    checked_rg: "{1}から{2}の項目を選択してください",
    checked_gt: "少なくとも{1}の項目を選択してください",
    checked_lt: "{1}の項目まで選択してください",

    length_eq: "{1}文字を入力してください",
    length_rg: "{1}文字から{2}文字までの値を入力してください",
    length_gt: "{1}文字以上で入力してください",
    length_lt: "{1}文字以内で入力してください",
    length_eq_2: "",
    length_lt_2: "",
    length_gt_2: "",
    length_lt_2: ""
