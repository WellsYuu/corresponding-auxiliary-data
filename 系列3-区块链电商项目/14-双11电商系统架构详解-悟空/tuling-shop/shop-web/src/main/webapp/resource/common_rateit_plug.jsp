...
<link href="<%=request.getContextPath()%>/resource/js/rateit/rateit.css" rel="stylesheet" type="text/css">
...
<script src="<%=request.getContextPath()%>/resource/js/rateit/jquery.rateit.js" type="text/javascript"></script>