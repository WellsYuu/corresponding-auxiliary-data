...
public class CangSmallMovie implements SmallMovie{
	...
	@Override
	public void watch() {
		System.out.println("苍老师，为您表演，此处少儿不宜");
	...
	public CangSmallMovie(String actor) {
		super();
		this.actor = actor;
	}
	...
	public CangSmallMovie(String actor, String director) {
		super();
		this.actor = actor;
	...
	public CangSmallMovie(String actor, String director, String bianju) {
		super();
		this.actor = actor;
		this.director = director;
		this.bianju = bianju;
