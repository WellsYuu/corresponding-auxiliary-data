...
package com.tl.sql重写;

import com.google.common.base.Optional;

import com.tl.fixture.ShardingRuleMockBuilder;
...
public final class SQLRewriteEngineTest {
    ...
    public void assertRewriteForTableName() {
        ...
        SQLRewriteEngine rewriteEngine = new SQLRewriteEngine(shardingRule, "SELECT * FROM table_x x WHERE table_x.id=? AND x.name=?", DatabaseType.MySQL, selectStatement);
        System.out.println(rewriteEngine.rewrite(true).toSQL(tableTokens));
    }
