...
public class BrokerAction extends AbstractAction {
    ...
    @RequestMapping(value = "/brokerStats", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/updateBrokerConfig", method = { RequestMethod.GET, RequestMethod.POST })
