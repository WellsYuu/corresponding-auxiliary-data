...
public class NamesrvAction extends AbstractAction {
    ...
    @RequestMapping(value = "/updateKvConfig", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/deleteKvConfig", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/getProjectGroup", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/updateProjectGroup", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/deleteProjectGroup", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/wipeWritePerm", method = { RequestMethod.GET, RequestMethod.POST })
