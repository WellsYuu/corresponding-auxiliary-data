...
public class MessageAction extends AbstractAction {
    ...
    @RequestMapping(value = "/queryMsgByKey", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/queryMsgByOffset", method = { RequestMethod.GET, RequestMethod.POST })
