...
public class ConsumerAction extends AbstractAction {
    ...
    @RequestMapping(value = "/consumerProgress", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/deleteSubGroup", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/updateSubGroup", method = { RequestMethod.GET, RequestMethod.POST })
