...
public class ConnectionAction extends AbstractAction {
    ...
    @RequestMapping(value = "/consumerConnection", method = { RequestMethod.GET, RequestMethod.POST })
    ...
    @RequestMapping(value = "/producerConnection", method = { RequestMethod.GET, RequestMethod.POST })
